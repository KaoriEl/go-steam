...
If this is useful to you, there's also the [go-steamapi](https://github.com/KaoriEl/go-steamapi) package that wraps some of the official Steam Web API's types.
...
[online on godoc.org](http://godoc.org/github.com/KaoriEl/go-steam).

You should also take a look at the following sub-packages:

  * [`gsbot`](http://godoc.org/github.com/KaoriEl/go-steam/gsbot) utilites that make writing bots easier
  * [example bot](http://godoc.org/github.com/KaoriEl/go-steam/gsbot/gsbot) and [its source code](https://github.com/KaoriEl/go-steam/blob/master/gsbot/gsbot/gsbot.go)
  * [`trade`](http://godoc.org/github.com/KaoriEl/go-steam/trade) for trading
  * [`tradeoffer`](http://godoc.org/github.com/KaoriEl/go-steam/tradeoffer) for trade offers
  * [`economy/inventory`](http://godoc.org/github.com/KaoriEl/go-steam/economy/inventory) for inventories
  * [`tf2`](http://godoc.org/github.com/KaoriEl/go-steam/tf2) for Team Fortress 2 related things
