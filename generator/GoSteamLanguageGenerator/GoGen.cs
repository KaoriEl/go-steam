...
namespace GoSteamLanguageGenerator
{
    public class GoGen
    {
        ...
        public void EmitClasses(Node root, StringBuilder sb)
        {
            ...
            sb.AppendLine("    \"github.com/KaoriEl/go-steam/v3/steamid\"");
            sb.AppendLine("    \"github.com/KaoriEl/go-steam/v3/rwu\"");
            sb.AppendLine("    \"github.com/KaoriEl/go-steam/v3/protocol/protobuf\"");
            sb.AppendLine(")");
            sb.AppendLine();
